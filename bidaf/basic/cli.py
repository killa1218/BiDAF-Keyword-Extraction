...
flags.DEFINE_bool("profiling", False, "save Timeline info for profiling? [False]")
...
flags.DEFINE_integer("num_steps", 200000, "Number of steps [20000]")
flags.DEFINE_integer("load_step", 0, "load step [0]")
flags.DEFINE_float("init_lr", 2, "Initial learning rate [0.5]")
...
flags.DEFINE_integer("decoder_proj_dim", 100, "size of v in pointer decoder [100]")
...
flags.DEFINE_bool("GRU", True, "Use GRUCell instead of LSTMCell in RNN? [True]")
flags.DEFINE_integer("highway_num_layers", 2, "highway num layers [2]")
flags.DEFINE_integer("LSTM_num_layers", 1, "LSTM num layers [2]")
...
flags.DEFINE_integer("max_answer_length", 64, "maximum answer length [64]")
flags.DEFINE_bool("conditional_probability", False, "use conditional prob when choosing answer. [False]")
...
flags.DEFINE_integer("eval_period", 1000000, "Eval period [1000]")
flags.DEFINE_integer("save_period", 5000, "Save Period [1000]")
flags.DEFINE_integer("max_to_keep", 200, "Max recent saves to keep [20]")
...
flags.DEFINE_bool("debug_verbose", False, "print verbose debug info [False]")
...
flags.DEFINE_bool("use_exact_match", True, "use exact match feature? [True]")
